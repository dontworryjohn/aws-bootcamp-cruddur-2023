...
Requirements:
- Install [**Thunder Client**](https://www.thunderclient.com/) on your VScode. This tool will be necessary to test the api that we will be generating.
...
```
>Note: change the nme of the bucket with yours.
...
>**insert screenshot here or procedure to show how to use thuder client**
